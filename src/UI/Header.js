            ...
            {!user ?
                (<div>
                    <ul className="flex justify-between">
                        <li className="mr-3">
                            <a href="/" className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 mr-4 lg:mt-0">Login</a>
                        </li>
                        <li className="mr-3">
